...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func createEditableCopyOfDatabaseIfNeeded()
    {
        ...
        let docDir = paths[0] as NSString // Documents Directory is the first path
        ...
        {
            let defaultDbPath = NSBundle.mainBundle().pathForResource("PersonalFinance", ofType: "sqlite")!
            do
            {
                try fm.copyItemAtPath(defaultDbPath, toPath: dbPath)
            }
